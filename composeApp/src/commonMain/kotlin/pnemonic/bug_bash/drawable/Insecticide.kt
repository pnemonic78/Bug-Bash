...
val Insecticide: ImageVector
    get() {
        if (_Insecticide != null) {
            return _Insecticide!!
        }
        _Insecticide = ImageVector.Builder(
            name = "Insecticide",
            defaultWidth = 16.116.dp,
            defaultHeight = 26.672.dp,
            viewportWidth = 16.116f,
            viewportHeight = 26.672f
        ).apply {
            path(fill = SolidColor(Color(0xFFFBCC02))) {
                moveTo(6.153f, 0.869f)
                lineToRelative(2.469f, 0.356f)
                lineToRelative(-0f, 1.108f)
            ...
            path(fill = SolidColor(Color(0xFFD8D8D8))) {
                moveTo(16.116f, 14.156f)
                arcToRelative(2.946f, 3.014f, 90f, isMoreThanHalf = true, isPositiveArc = true, -6.028f, 0f)
                arcToRelative(2.946f, 3.014f, 90f, isMoreThanHalf = true, isPositiveArc = true, 6.028f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFF23812))) {
                moveTo(16.116f, 14.156f)
                lineToRelative(-6.028f, 0f)
                lineToRelative(-0f, 12.516f)
                lineToRelative(6.028f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFF23812))) {
                moveTo(13.715f, 9.186f)
                lineToRelative(0.889f, 0.274f)
                lineToRelative(-0f, 0.401f)
                lineToRelative(-0.889f, 0.279f)
                close()
            }
            path(fill = SolidColor(Color(0xFFD8D8D8))) {
                moveTo(13.86f, 9.034f)
                lineToRelative(-1.228f, 0f)
                lineToRelative(-0f, 1.695f)
                lineToRelative(1.228f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFF23812))) {
                moveTo(14.322f, 10.625f)
                lineToRelative(-2.151f, 0f)
                lineToRelative(-0f, 0.809f)
                lineToRelative(2.151f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFDB2305))) {
                moveTo(11.375f, 14.156f)
                lineToRelative(-1.287f, 0f)
                lineToRelative(-0f, 12.516f)
                lineToRelative(1.287f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFF9AE06))) {
                moveToRelative(13.265f, 15.272f)
            ...
            path(fill = SolidColor(Color.White)) {
                moveToRelative(11.353f, 17.43f)
                curveToRelative(0.001f, -0.003f, 0.002f, -0.006f, 0.004f, -0.01f)
                curveToRelative(0.004f, -0.008f, 0.006f, -0.018f, 0.011f, -0.025f)
                curveToRelative(0.086f, -0.141f, 0.294f, -0.205f, 0.448f, -0.251f)
                curveToRelative(0.157f, -0.047f, 0.312f, -0.101f, 0.466f, -0.158f)
                curveToRelative(0.121f, -0.044f, 0.241f, -0.087f, 0.353f, -0.146f)
                curveToRelative(0.002f, -0.002f, 0.004f, -0.004f, 0.006f, -0.007f)
                curveToRelative(-0.003f, -0.026f, -0.005f, -0.052f, -0.004f, -0.074f)
                curveToRelative(-0.024f, -0.021f, -0.057f, -0.049f, -0.09f, -0.075f)
                curveToRelative(-0.067f, -0.051f, -0.209f, -0.207f, -0.268f, -0.295f)
                curveToRelative(-0.039f, -0.059f, -0.041f, -0.092f, -0.036f, -0.11f)
                curveToRelative(-0.052f, -0.084f, -0.007f, -0.119f, -0.13f, -0.27f)
                curveToRelative(-0.032f, -0.04f, -0.04f, -0.065f, -0.04f, -0.08f)
                curveToRelative(-0.061f, -0.045f, -0.205f, -0.129f, -0.306f, -0.189f)
                curveToRelative(-0.112f, -0.067f, -0.352f, -0.193f, -0.425f, -0.289f)
                curveToRelative(-0.054f, -0.07f, -0.002f, -0.064f, 0.096f, 0.017f)
                curveToRelative(0.074f, 0.061f, 0.329f, 0.216f, 0.483f, 0.294f)
                curveToRelative(0.086f, 0.044f, 0.137f, 0.108f, 0.158f, 0.148f)
                lineToRelative(0.001f, -0.001f)
                curveToRelative(-0f, 0f, 0.051f, 0.046f, 0.119f, 0.139f)
                curveToRelative(0.048f, 0.066f, 0.055f, 0.163f, 0.055f, 0.213f)
                curveToRelative(0.004f, 0.008f, 0.079f, 0.139f, 0.27f, 0.328f)
                curveToRelative(0.058f, 0.057f, 0.094f, 0.105f, 0.117f, 0.141f)
                curveToRelative(0.004f, -0.026f, 0.01f, -0.049f, 0.02f, -0.058f)
                curveToRelative(0.005f, -0.005f, 0.011f, -0.008f, 0.016f, -0.013f)
                curveToRelative(0.039f, -0.031f, 0.083f, -0.048f, 0.124f, -0.058f)
                curveToRelative(-0.021f, -0.011f, -0.039f, -0.024f, -0.055f, -0.041f)
                lineToRelative(-0f, 0.002f)
                curveToRelative(-0f, 0f, -0.119f, -0.06f, -0.11f, -0.166f)
                curveToRelative(0.008f, -0.106f, 0.145f, -0.12f, 0.145f, -0.12f)
                lineToRelative(-0.001f, 0.004f)
                curveToRelative(0.008f, -0.006f, 0.015f, -0.012f, 0.024f, -0.016f)
                curveToRelative(-0.037f, -0.069f, -0.122f, -0.22f, -0.214f, -0.336f)
                curveToRelative(-0.114f, -0.144f, -0.131f, -0.188f, -0.033f, -0.123f)
                curveToRelative(0.072f, 0.048f, 0.212f, 0.283f, 0.257f, 0.454f)
                curveToRelative(0.012f, -0.005f, 0.025f, -0.005f, 0.038f, -0.008f)
                lineToRelative(0.021f, -0.943f)
                lineToRelative(0.048f, 0.942f)
                curveToRelative(0.012f, 0.002f, 0.026f, 0.003f, 0.037f, 0.007f)
                curveToRelative(0.045f, -0.171f, 0.184f, -0.406f, 0.256f, -0.454f)
                curveToRelative(0.098f, -0.065f, 0.081f, -0.02f, -0.033f, 0.123f)
                curveToRelative(-0.092f, 0.115f, -0.176f, 0.266f, -0.214f, 0.335f)
                curveToRelative(0.008f, 0.004f, 0.014f, 0.01f, 0.022f, 0.015f)
                lineToRelative(-0f, -0.003f)
                curveToRelative(-0f, 0f, 0.137f, 0.014f, 0.145f, 0.12f)
                curveToRelative(0.008f, 0.106f, -0.104f, 0.163f, -0.104f, 0.163f)
                lineToRelative(-0.001f, -0.003f)
                curveToRelative(-0.016f, 0.018f, -0.034f, 0.033f, -0.056f, 0.044f)
                curveToRelative(0.028f, 0.007f, 0.057f, 0.017f, 0.086f, 0.034f)
                curveToRelative(0.018f, 0.01f, 0.035f, 0.023f, 0.052f, 0.038f)
                curveToRelative(0.012f, 0.011f, 0.019f, 0.038f, 0.022f, 0.072f)
                curveToRelative(0.022f, -0.037f, 0.06f, -0.09f, 0.127f, -0.156f)
                curveToRelative(0.192f, -0.188f, 0.266f, -0.32f, 0.27f, -0.328f)
                curveToRelative(-0f, -0.05f, 0.007f, -0.147f, 0.055f, -0.213f)
                curveToRelative(0.067f, -0.092f, 0.119f, -0.139f, 0.119f, -0.139f)
                lineToRelative(0.001f, 0.001f)
                curveToRelative(0.021f, -0.04f, 0.073f, -0.104f, 0.159f, -0.148f)
                curveToRelative(0.154f, -0.079f, 0.409f, -0.234f, 0.483f, -0.294f)
                curveToRelative(0.098f, -0.08f, 0.15f, -0.087f, 0.096f, -0.017f)
                curveToRelative(-0.074f, 0.096f, -0.314f, 0.222f, -0.426f, 0.289f)
                curveToRelative(-0.102f, 0.061f, -0.246f, 0.144f, -0.306f, 0.189f)
                curveToRelative(-0f, 0.015f, -0.007f, 0.04f, -0.04f, 0.08f)
                curveToRelative(-0.123f, 0.152f, -0.078f, 0.186f, -0.13f, 0.27f)
                curveToRelative(0.005f, 0.019f, 0.003f, 0.051f, -0.036f, 0.11f)
                curveToRelative(-0.059f, 0.089f, -0.201f, 0.244f, -0.268f, 0.295f)
                curveToRelative(-0.04f, 0.031f, -0.078f, 0.064f, -0.102f, 0.085f)
                curveToRelative(0f, 0.021f, -0.001f, 0.044f, -0.004f, 0.068f)
                curveToRelative(0.114f, 0.06f, 0.236f, 0.103f, 0.358f, 0.148f)
                curveToRelative(0.154f, 0.056f, 0.309f, 0.11f, 0.466f, 0.158f)
                curveToRelative(0.154f, 0.046f, 0.362f, 0.111f, 0.448f, 0.251f)
                curveToRelative(0.004f, 0.007f, 0.007f, 0.017f, 0.011f, 0.025f)
                curveToRelative(0.002f, 0.003f, 0.003f, 0.006f, 0.004f, 0.01f)
                curveToRelative(0.004f, 0.012f, 0.007f, 0.022f, 0.009f, 0.034f)
                curveToRelative(0.001f, 0.005f, 0.004f, 0.01f, 0.004f, 0.014f)
                curveToRelative(0.001f, 0.011f, -0f, 0.023f, -0.003f, 0.034f)
                curveToRelative(-0.006f, 0.02f, -0.014f, 0.033f, -0.024f, 0.042f)
                curveToRelative(-0.091f, 0.12f, -0.412f, 0.116f, -0.737f, -0.053f)
                curveToRelative(-0.074f, -0.038f, -0.14f, -0.083f, -0.202f, -0.13f)
                curveToRelative(0.013f, 0.028f, 0.03f, 0.064f, 0.049f, 0.114f)
                curveToRelative(0.039f, 0.099f, 0.167f, 0.355f, 0.207f, 0.436f)
                curveToRelative(0.047f, 0.051f, 0.085f, 0.079f, 0.109f, 0.228f)
                curveToRelative(0.026f, 0.159f, 0.078f, 0.498f, 0.055f, 0.588f)
                curveToRelative(-0.022f, 0.087f, -0.048f, 0.12f, -0.051f, 0.077f)
                curveToRelative(-0.004f, -0.053f, 0.006f, -0.142f, 0.002f, -0.223f)
                curveToRelative(-0.012f, -0.217f, -0.022f, -0.281f, -0.057f, -0.419f)
                curveToRelative(-0.028f, -0.115f, -0.047f, -0.186f, -0.058f, -0.225f)
                curveToRelative(-0.015f, -0.006f, -0.043f, -0.028f, -0.093f, -0.103f)
                curveToRelative(-0.06f, -0.092f, -0.12f, -0.255f, -0.148f, -0.326f)
                curveToRelative(-0.036f, -0.09f, -0.047f, -0.143f, -0.048f, -0.172f)
                curveToRelative(-0.12f, -0.096f, -0.22f, -0.203f, -0.29f, -0.309f)
                curveToRelative(-0.018f, -0.027f, -0.03f, -0.052f, -0.044f, -0.078f)
                curveToRelative(-0.001f, 0.002f, -0.002f, 0.003f, -0.003f, 0.005f)
                curveToRelative(0.064f, 0.108f, 0.19f, 0.323f, 0.228f, 0.41f)
                curveToRelative(0.026f, 0.06f, 0.022f, 0.114f, 0.016f, 0.147f)
                curveToRelative(0.005f, 0.03f, 0.011f, 0.08f, 0.015f, 0.156f)
                curveToRelative(0.005f, 0.109f, 0.048f, 0.403f, 0.06f, 0.485f)
                curveToRelative(0.037f, 0.04f, 0.067f, 0.08f, 0.088f, 0.205f)
                curveToRelative(0.026f, 0.159f, -0.01f, 0.905f, -0.032f, 0.995f)
                curveToRelative(-0.022f, 0.087f, -0.048f, 0.12f, -0.051f, 0.077f)
                curveToRelative(-0.004f, -0.053f, 0.006f, -0.142f, 0.002f, -0.223f)
                curveToRelative(-0.012f, -0.217f, 0.065f, -0.688f, 0.031f, -0.827f)
                curveToRelative(-0.028f, -0.114f, -0.047f, -0.185f, -0.058f, -0.224f)
                curveToRelative(-0.012f, -0.017f, -0.027f, -0.05f, -0.043f, -0.113f)
                curveToRelative(-0.027f, -0.106f, -0.033f, -0.28f, -0.038f, -0.356f)
                curveToRelative(-0.006f, -0.098f, 0.001f, -0.151f, 0.009f, -0.179f)
                curveToRelative(-0.011f, -0.035f, -0.034f, -0.095f, -0.081f, -0.183f)
                curveToRelative(-0.057f, -0.105f, -0.141f, -0.236f, -0.177f, -0.318f)
                curveToRelative(-0.025f, 0.03f, -0.056f, 0.051f, -0.095f, 0.053f)
                curveToRelative(-0.011f, 0.001f, -0.03f, 0.001f, -0.051f, 0.001f)
                curveToRelative(0.046f, 0.002f, 0.116f, 0.013f, 0.146f, 0.065f)
                curveToRelative(0.018f, 0.033f, 0.041f, 0.096f, 0.058f, 0.184f)
                curveToRelative(0f, 0.001f, 0.001f, 0.003f, 0.001f, 0.003f)
                lineToRelative(-0.001f, -0.001f)
                curveToRelative(0.01f, 0.054f, 0.018f, 0.117f, 0.021f, 0.189f)
                curveToRelative(0f, 0f, 0.001f, 0.002f, 0.001f, 0.002f)
                lineToRelative(-0.001f, -0f)
                curveToRelative(0.003f, 0.064f, 0.002f, 0.134f, -0.005f, 0.211f)
                lineToRelative(0f, 0.001f)
                lineToRelative(-0f, 0f)
                curveToRelative(-0.004f, 0.04f, -0.008f, 0.08f, -0.015f, 0.123f)
                curveToRelative(-0.003f, 0.021f, -0.008f, 0.038f, -0.012f, 0.058f)
                curveToRelative(0.001f, 0.001f, 0.001f, 0.002f, 0.001f, 0.002f)
                lineToRelative(-0.001f, 0f)
                curveToRelative(-0.011f, 0.057f, -0.025f, 0.11f, -0.039f, 0.156f)
                curveToRelative(0f, 0f, 0.001f, 0.001f, 0.001f, 0.001f)
                lineToRelative(-0.001f, 0f)
                curveToRelative(-0.071f, 0.224f, -0.166f, 0.336f, -0.166f, 0.336f)
                curveToRelative(-0f, 0f, -0.117f, -0.115f, -0.196f, -0.346f)
                curveToRelative(-0f, 0f, -0.002f, -0.001f, -0.002f, -0.001f)
                curveToRelative(-0f, 0f, 0.001f, -0.001f, 0.001f, -0.001f)
                curveToRelative(-0.021f, -0.061f, -0.04f, -0.129f, -0.052f, -0.206f)
                curveToRelative(-0.02f, -0.126f, -0.024f, -0.237f, -0.02f, -0.335f)
                lineToRelative(-0.001f, 0f)
                curveToRelative(-0f, 0f, 0.001f, -0.001f, 0.001f, -0.001f)
                curveToRelative(0.003f, -0.065f, 0.009f, -0.122f, 0.018f, -0.173f)
                lineToRelative(-0.001f, 0.001f)
                curveToRelative(-0f, 0f, 0.001f, -0.003f, 0.002f, -0.008f)
                curveToRelative(0.017f, -0.094f, 0.041f, -0.162f, 0.06f, -0.196f)
                curveToRelative(0.029f, -0.052f, 0.099f, -0.063f, 0.146f, -0.065f)
                curveToRelative(-0.021f, -0f, -0.04f, -0.001f, -0.051f, -0.001f)
                curveToRelative(-0.04f, -0.003f, -0.071f, -0.024f, -0.096f, -0.054f)
                curveToRelative(-0.035f, 0.082f, -0.12f, 0.213f, -0.177f, 0.318f)
                curveToRelative(-0.047f, 0.088f, -0.07f, 0.148f, -0.081f, 0.183f)
                curveToRelative(0.007f, 0.028f, 0.015f, 0.081f, 0.009f, 0.179f)
                curveToRelative(-0.004f, 0.076f, -0.01f, 0.25f, -0.037f, 0.356f)
                curveToRelative(-0.016f, 0.064f, -0.031f, 0.096f, -0.043f, 0.113f)
                curveToRelative(-0.011f, 0.04f, -0.03f, 0.11f, -0.058f, 0.224f)
                curveToRelative(-0.034f, 0.138f, 0.043f, 0.609f, 0.031f, 0.827f)
                curveToRelative(-0.005f, 0.081f, 0.006f, 0.169f, 0.002f, 0.223f)
                curveToRelative(-0.003f, 0.043f, -0.029f, 0.01f, -0.051f, -0.077f)
                curveToRelative(-0.022f, -0.09f, -0.058f, -0.836f, -0.032f, -0.995f)
                curveToRelative(0.02f, -0.125f, 0.051f, -0.165f, 0.088f, -0.205f)
                curveToRelative(0.012f, -0.082f, 0.055f, -0.376f, 0.06f, -0.485f)
                curveToRelative(0.003f, -0.076f, 0.01f, -0.126f, 0.015f, -0.156f)
                curveToRelative(-0.006f, -0.033f, -0.01f, -0.087f, 0.016f, -0.147f)
                curveToRelative(0.037f, -0.087f, 0.164f, -0.303f, 0.228f, -0.41f)
                curveToRelative(-0.001f, -0.002f, -0.003f, -0.004f, -0.003f, -0.006f)
                curveToRelative(-0.015f, 0.027f, -0.027f, 0.053f, -0.045f, 0.08f)
                curveToRelative(-0.078f, 0.119f, -0.192f, 0.24f, -0.333f, 0.344f)
                curveToRelative(-0.006f, 0.031f, -0.019f, 0.076f, -0.044f, 0.137f)
                curveToRelative(-0.028f, 0.071f, -0.089f, 0.234f, -0.148f, 0.326f)
                curveToRelative(-0.049f, 0.076f, -0.078f, 0.098f, -0.092f, 0.103f)
                curveToRelative(-0.011f, 0.039f, -0.03f, 0.11f, -0.058f, 0.225f)
                curveToRelative(-0.034f, 0.138f, -0.044f, 0.202f, -0.057f, 0.419f)
                curveToRelative(-0.004f, 0.081f, 0.006f, 0.169f, 0.002f, 0.223f)
                curveToRelative(-0.003f, 0.043f, -0.029f, 0.01f, -0.051f, -0.077f)
                curveToRelative(-0.022f, -0.09f, 0.029f, -0.429f, 0.055f, -0.588f)
                curveToRelative(0.024f, -0.148f, 0.062f, -0.177f, 0.109f, -0.228f)
                curveToRelative(0.041f, -0.08f, 0.169f, -0.336f, 0.207f, -0.435f)
                curveToRelative(0.011f, -0.028f, 0.02f, -0.051f, 0.029f, -0.071f)
                curveToRelative(-0.046f, 0.031f, -0.093f, 0.061f, -0.144f, 0.088f)
                curveToRelative(-0.324f, 0.168f, -0.646f, 0.172f, -0.737f, 0.053f)
                curveToRelative(-0.009f, -0.01f, -0.018f, -0.022f, -0.024f, -0.042f)
                curveToRelative(-0.003f, -0.012f, -0.004f, -0.023f, -0.003f, -0.034f)
                curveToRelative(0f, -0.005f, 0.003f, -0.01f, 0.004f, -0.014f)
                curveToRelative(0.002f, -0.013f, 0.005f, -0.024f, 0.01f, -0.035f)
                close()
            }
            path(fill = SolidColor(Color.White)) {
                moveTo(15.148f, 20.025f)
                lineToRelative(-4.417f, 0f)
                lineToRelative(-0f, 0.389f)
                lineToRelative(4.417f, 0f)
                close()
            }
            path(fill = SolidColor(Color.White)) {
                moveTo(15.148f, 22.742f)
                lineToRelative(-4.417f, 0f)
                lineToRelative(-0f, 0.389f)
                lineToRelative(4.417f, 0f)
                close()
            ...
            path(fill = SolidColor(Color(0xFFF9AE06))) {
                moveTo(15.148f, 20.922f)
                lineToRelative(-4.417f, 0f)
                lineToRelative(-0f, 1.24f)
                lineToRelative(4.417f, 0f)
                close()
            }
            path(fill = SolidColor(Color(0xFFC1C1C1))) {
                moveTo(12.94f, 9.034f)
                lineToRelative(-0.308f, 0f)
                lineToRelative(-0f, 1.547f)
                lineToRelative(0.308f, 0f)
                close()
            }
        }.build()
...
private var _Insecticide: ImageVector? = null
