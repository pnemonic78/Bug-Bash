    ...
    get() {
        ...
        _Bee = ImageVector.Builder(
            ...
            path(
                ...
                curveToRelative(-0.005f, 0.12f, -0.026f, 0.367f, -0.077f, 0.696f)
                curveToRelative(-0.012f, 0.072f, -0.026f, 0.145f, -0.043f, 0.226f)
                curveToRelative(-0.069f, 0.367f, -0.175f, 0.811f, -0.329f, 1.276f)
                curveToRelative(-0.23f, 0.691f, -0.563f, 1.437f, -1.05f, 2.086f)
                curveToRelative(-0.555f, 0.742f, -1.301f, 1.356f, -2.303f, 1.621f)
                curveToRelative(-0.405f, 0.107f, -0.854f, 0.158f, -1.349f, 0.132f)
                curveToRelative(-0.392f, -0.012f, -0.819f, -0.08f, -1.28f, -0.2f)
                curveToRelative(-0.188f, -0.052f, -0.385f, -0.111f, -0.58f, -0.175f)
                curveToRelative(-5.705f, -2.001f, -14.221f, -11.964f, -13.735f, -13.837f)
                curveToRelative(0.503f, -1.933f, 5.726f, 0.35f, 11.414f, 1.831f)
                curveToRelative(0.763f, 0.197f, 1.48f, 0.328f, 2.15f, 0.414f)
                curveToRelative(0.781f, 0.102f, 1.498f, 0.144f, 2.155f, 0.167f)
                curveToRelative(0.644f, 0.017f, 1.229f, 0.012f, 1.758f, 0.017f)
                lineToRelative(0.136f, 0f)
                curveToRelative(0.675f, 0.004f, 1.246f, 0.034f, 1.72f, 0.153f)
                curveToRelative(0.763f, 0.188f, 1.268f, 0.619f, 1.506f, 1.587f)
                curveToRelative(0.089f, 3.294f, -0.074f, 3.196f, -0.094f, 4.006f)
                close()
            }
        }.build()
