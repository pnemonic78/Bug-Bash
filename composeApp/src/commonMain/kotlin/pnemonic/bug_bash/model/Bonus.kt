...
sealed class Bonus(val score: Int, val hits: Int, val sound: SoundType, progress: Int = 0) {
    ...
    class GluePaper(progress: Int = 0) :
    ...
    class Score(progress: Int = 0) :
        Bonus(score = 1000, hits = 1000, sound = SoundType.Clang, progress = progress)
